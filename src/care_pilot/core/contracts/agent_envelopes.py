"""Agent I/O envelope contracts for the application layer.

Defines the typed envelope structures that wrap agent inputs, outputs, audit
traces, and handoffs.  These contracts are consumed by the workflow coordinator,
the meals presenter, and infrastructure adapters (media ingestion, notifications).
"""
