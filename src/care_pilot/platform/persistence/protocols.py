...
class ClinicalRepositoryProtocol(Protocol):
    ...
    def save_biomarker_reading(self, user_id: str, reading: Any) -> None: ...
...
class ReminderRepositoryProtocol(Protocol):
    ...
    def list_message_preferences(
        self, *, user_id: str, scope_type: str | None = None, scope_key: str | None = None
    ) -> list[Any]: ...
    ...
    def list_scheduled_messages(
        self, *, reminder_id: str | None = None, user_id: str | None = None
    ) -> list[Any]: ...
    ...
    def get_message_endpoint(self, *, endpoint_id: str) -> Any | None: ...
    def get_message_endpoint_by_destination(
        self, *, user_id: str, channel: str, destination: str
    ) -> Any | None: ...
    def list_message_logs(self, *, reminder_id: str) -> list[Any]: ...
    ...
    def append_message_thread_message(self, message: Any) -> None: ...
    def list_message_thread_messages(self, *, thread_id: str) -> list[Any]: ...
    ...
    def mark_scheduled_notification_dead_letter(
        self, notification_id: str, *args: Any, **kwargs: Any
    ) -> Any: ...
...
class EventingRepositoryProtocol(Protocol):
