...
from care_pilot.features.profiles.domain.models import ProfileMode
from care_pilot.platform.auth import AuthUserRecord
...
def login_and_create_session(
    *, auth_store: AuthStorePort, email: str, password: str
) -> AuthSessionResult:
