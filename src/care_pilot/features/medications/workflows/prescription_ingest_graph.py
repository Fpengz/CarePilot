...
class Start(
    BaseNode[
        PrescriptionIngestState,
        PrescriptionIngestDeps,
...
prescription_ingest_graph: Graph[
    PrescriptionIngestState, PrescriptionIngestDeps, PrescriptionIngestOutput
] = Graph(
...
async def run_prescription_ingest_workflow(
    *,
    ...
    result = await prescription_ingest_graph.run(
