...
from care_pilot.features.profiles.domain.onboarding import (
...
def to_profile_response(*, profile, fallback_mode: bool) -> HealthProfileResponseItem:
    ...
    return HealthProfileResponseItem(
        ...
        conditions=[
            HealthProfileCondition.model_validate(item.model_dump(mode="json"))
        ...
        completeness=HealthProfileCompletenessResponse.model_validate(
