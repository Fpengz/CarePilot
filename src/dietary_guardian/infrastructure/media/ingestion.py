"""Media capture deduplication and envelope construction.

Pure utilities for building ``CaptureEnvelope`` objects and detecting
duplicate capture submissions within a session state window.
"""
...
def should_suppress_duplicate_capture(
    ...
    *,
    ...
    """Return ``True`` when the same image has been seen within ``window_seconds``."""
