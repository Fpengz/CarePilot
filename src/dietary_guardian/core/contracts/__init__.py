...
_EXPORT_MAP = {
    ...
    "EmotionConfidenceBand": ("dietary_guardian.features.companion.core.health.emotion", "EmotionConfidenceBand"),
    "EmotionEvidence": ("dietary_guardian.features.companion.core.health.emotion", "EmotionEvidence"),
    "EmotionInferenceResult": ("dietary_guardian.features.companion.core.health.emotion", "EmotionInferenceResult"),
    "EmotionLabel": ("dietary_guardian.features.companion.core.health.emotion", "EmotionLabel"),
    "EmotionRuntimeHealth": ("dietary_guardian.features.companion.core.health.emotion", "EmotionRuntimeHealth"),
    ...
    "InferenceHealth": ("dietary_guardian.agent.shared.ai.types", "InferenceHealth"),
    "InferenceModality": ("dietary_guardian.agent.shared.ai.types", "InferenceModality"),
    "InferenceRequest": ("dietary_guardian.agent.shared.ai.types", "InferenceRequest"),
    "InferenceResponse": ("dietary_guardian.agent.shared.ai.types", "InferenceResponse"),
    "PresentationMessage": ("dietary_guardian.core.contracts.agent_envelopes", "PresentationMessage"),
    "ProviderMetadata": ("dietary_guardian.agent.shared.ai.types", "ProviderMetadata"),
