...
from dietary_guardian.features.recommendations.domain.schemas import RecommendationAgentInput
from dietary_guardian.features.companion.core.health.models import ReportInput
from dietary_guardian.features.profiles.domain.health_profile import resolve_user_profile
...
from dietary_guardian.features.reports.domain import build_clinical_snapshot, parse_report_input
from dietary_guardian.features.safety.domain.triage import evaluate_text_safety
