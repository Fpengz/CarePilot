...
from dietary_guardian.features.recommendations.domain.scoring import (
    FoodItem,
    _clamp,
    _infer_slot,
    _score_similarity,
...
if TYPE_CHECKING:
    from dietary_guardian.features.recommendations.domain.engine import RecommendationAgentRepository
