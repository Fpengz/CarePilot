...
from dietary_guardian.features.companion.clinician_digest.digest import build_clinician_digest
...
from dietary_guardian.features.companion.personalization.personalization import build_personalization_context
from dietary_guardian.features.companion.core.snapshot import build_case_snapshot
from dietary_guardian.features.companion.core.evidence import (
    EvidenceRetrievalPort,
    retrieve_supporting_evidence,
)
from dietary_guardian.features.safety.service import apply_safety_decision, review_care_plan
