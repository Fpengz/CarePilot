...
from dietary_guardian.features.meals.domain.models import MealEvent, MealState
from dietary_guardian.features.safety.domain.exceptions import SafetyViolation
from dietary_guardian.features.safety.domain.ports import DrugInteractionRepository
from dietary_guardian.features.safety.domain.thresholds import (
