...
from dietary_guardian.features.safety.domain.alerts.models import AlertSeverity
from dietary_guardian.features.profiles.domain.models import UserProfile
from dietary_guardian.platform.observability.tooling.domain.tool_policy import (
...
from dietary_guardian.core.contracts.agent_envelopes import AgentHandoff, CaptureEnvelope
