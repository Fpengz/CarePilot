...
from dietary_guardian.platform.persistence.food.local_retriever import (
    COLLECTION_NAME,
    EMBEDDING_MODEL,
    VECTORSTORE_DIR,
)

STATIC_DATA_DIR = Path(__file__).resolve().parents[5] / "src" / "dietary_guardian" / "data"
            ...
            chunks.append(
                {
                    ...
                    "metadata": {"chunk_type": "ordering_tips", "source": "sg_drinks_local"},
                }
            )
