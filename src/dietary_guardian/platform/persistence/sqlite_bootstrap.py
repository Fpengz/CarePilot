...
from dietary_guardian.features.recommendations.domain import CanonicalFoodRecord, MealCatalogItem
...
COLUMN_MIGRATIONS: tuple[tuple[str, str, str], ...] = (
    ...
    ("medication_regimens", "frequency_type", "TEXT NOT NULL DEFAULT 'fixed_time'"),
    ("medication_regimens", "frequency_times_per_day", "INTEGER NOT NULL DEFAULT 1"),
