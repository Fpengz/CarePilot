...
from dietary_guardian.platform.observability.tooling.domain.authorization import scopes_for_account_role
from dietary_guardian.platform.auth.demo_defaults import build_demo_user_seeds
from dietary_guardian.platform.auth.in_memory import AuthUserRecord, PasswordHasher
