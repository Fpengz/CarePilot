"""Context-building helpers shared across companion API endpoints.

These helpers bridge the API-layer AppContext with the application domain.
Phase 3 cleanup: decouple from AppContext and apps.api.dietary_api.schemas.
"""
...
from dietary_guardian.application.companion.use_cases import CompanionStateInputs
