...
from dietary_guardian.domain.meals.agent_schemas import MealAnalysisAgentInput
...
from dietary_guardian.domain.identity.health_profile import get_or_create_health_profile
