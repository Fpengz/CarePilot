...
_MEAL_LABEL_RE = re.compile(r"^\s*(breakfast|lunch|dinner|supper)\s*(?:was|is|:)?\s*(.+)$", re.IGNORECASE)
...
def heuristic_meal_log_intent(message: str) -> Tuple[MealLogIntentResult, bool]:
