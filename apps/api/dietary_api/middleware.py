"""
Define request middleware for the dietary API.

This module provides timing, rate-limit, and error-response middleware that
apply consistent policies across API routes.
"""
...
from dietary_guardian.platform.cache import build_rate_limiter
