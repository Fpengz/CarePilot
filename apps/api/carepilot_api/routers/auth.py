...
def auth_login(
    payload: AuthLoginRequest, response: Response, request: Request
) -> AuthLoginResponse:
...
def auth_signup(
    payload: AuthSignupRequest, response: Response, request: Request
) -> AuthLoginResponse:
...
@router.post(
    ...
    response_model=AuthSessionRevokeOthersResponse,
)
...
@router.post(
    ...
    response_model=AuthSessionRevokeResponse,
)
