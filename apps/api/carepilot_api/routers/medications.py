...
@router.get(
    ...
    response_model=MedicationRegimenListResponse,
)
...
@router.post(
    "/api/v1/medications/regimens",
    response_model=MedicationRegimenEnvelopeResponse,
)
...
@router.patch(
    "/api/v1/medications/intake/drafts/{draft_id}/instructions/{instruction_index}",
    response_model=MedicationIntakeResponse,
)
...
@router.delete(
    "/api/v1/medications/intake/drafts/{draft_id}",
    response_model=MedicationDraftDeleteResponse,
)
...
@router.patch(
    "/api/v1/medications/regimens/{regimen_id}",
    response_model=MedicationRegimenEnvelopeResponse,
)
...
@router.delete(
    "/api/v1/medications/regimens/{regimen_id}",
    response_model=MedicationRegimenDeleteResponse,
)
...
@router.post(
    ...
    response_model=MedicationAdherenceEventEnvelopeResponse,
)
...
@router.get(
    "/api/v1/medications/adherence-metrics",
    response_model=MedicationAdherenceMetricsResponse,
)
