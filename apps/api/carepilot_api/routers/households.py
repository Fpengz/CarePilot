...
@router.get(
    "/api/v1/households/{household_id}/care/members",
    response_model=HouseholdCareMembersResponse,
)
...
@router.post(
    "/api/v1/households/{household_id}/members/{user_id}/remove",
    response_model=HouseholdMemberRemoveResponse,
)
