...
- File: `src/care_pilot/features/meals/workflows/meal_upload_graph.py`
- Graph nodes: `Start -> PerceiveMeal -> ReconcileClaims -> Persist`.
- State: `MealUploadState` in `src/care_pilot/features/meals/workflows/meal_upload_state.py`.
...
- Implementation:
  - `HawkerVisionModule.analyze_and_record(...)` in `src/care_pilot/agent/meal_analysis/vision_module.py`
  - Normalization via `normalize_vision_result(...)` in `src/care_pilot/features/meals/use_cases.py`.
...
- If both exist and disagree, it attempts arbitration via:
  - `arbitrate_meal_label(...)` in `src/care_pilot/agent/meal_analysis/arbitration.py`
...
- `MealUploadOutput`:
  - File: `src/care_pilot/features/meals/workflows/meal_upload_output.py`
...
- File: `src/care_pilot/features/meals/logging.py`
...
- API route: `apps/api/carepilot_api/routers/meals.py`
- API orchestration: `src/care_pilot/features/meals/api_service.py`
- Workflow graph: `src/care_pilot/features/meals/workflows/meal_upload_graph.py`
- Workflow state/output:
  - `src/care_pilot/features/meals/workflows/meal_upload_state.py`
  - `src/care_pilot/features/meals/workflows/meal_upload_output.py`
- Vision module: `src/care_pilot/agent/meal_analysis/vision_module.py`
- Perception agent (direct agent helper): `src/care_pilot/agent/meal_analysis/meal_perception_agent.py`
- Arbitration agent: `src/care_pilot/agent/meal_analysis/arbitration.py`
- Normalization + records: `src/care_pilot/features/meals/use_cases.py`
- Domain models: `src/care_pilot/features/meals/domain/models.py`
- Logging: `src/care_pilot/features/meals/logging.py`
