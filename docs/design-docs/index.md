...
Design documentation and architecture references. Update this index when new design docs are added.
...
| `docs/design-docs/architecture/meal-analysis-workflow.md` | active | 2026-03-29 | features |
| `docs/design-docs/architecture/backend-problems.md` | draft | 2026-03-29 | platform |
| `docs/design-docs/architecture/event_driven_choreography.md` | draft | 2026-03-29 | platform |
| `docs/design-docs/architecture/performance_strategy.md` | draft | 2026-03-29 | platform |
| `docs/design-docs/architecture/multi_modal_memory_roadmap.md` | draft | 2026-03-29 | agent |
...
| `docs/design-docs/architecture/event-driven/IMPLEMENTATION_PLAN.md` | active | 2026-03-29 | platform |
