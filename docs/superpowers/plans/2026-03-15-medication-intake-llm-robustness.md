...
**Files:**
- Modify: `tests/capabilities/test_inference_engine.py`
- Modify: `tests/features/test_medication_intake_parser.py`
...
Run: `pytest tests/capabilities/test_inference_engine.py::test_inference_engine_recovers_json_from_chatty_output -v`
...
Run: `pytest tests/features/test_medication_intake_parser.py::test_parse_llm_output_list_wrapper_is_coerced -v`
...
**Files:**
- Modify: `src/care_pilot/agent/runtime/inference_engine.py`
...
**Files:**
- Modify: `src/care_pilot/features/medications/intake/parser.py`
...
Run: `pytest tests/features/test_medication_intake_parser.py -v`
...
**Files:**
- Modify: `apps/web/lib/console-safe.test.ts`
...
Run: `SETUPTOOLS_SCM_PRETEND_VERSION=0.0.0 uv run pytest tests/capabilities/test_inference_engine.py tests/features/test_medication_intake_parser.py -q`
...
```bash
git add src/care_pilot/agent/runtime/inference_engine.py \
  src/care_pilot/features/medications/intake/parser.py \
  apps/web/lib/api/core.ts \
  tests/capabilities/test_inference_engine.py \
  tests/features/test_medication_intake_parser.py \
  apps/web/lib/console-safe.test.ts
