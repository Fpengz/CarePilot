...
- `GET /api/v1/reminders/{event_id}/message-schedules` -> `reminder:read`
- `GET /api/v1/reminders/{event_id}/message-logs` -> `reminder:read`
- `GET /api/v1/message-preferences` -> `reminder:read`
- `PUT /api/v1/message-preferences/default` -> `reminder:write`
- `PUT /api/v1/message-preferences/reminder-types/{type}` -> `reminder:write`
- `GET /api/v1/message-endpoints` -> `reminder:read`
- `PUT /api/v1/message-endpoints` -> `reminder:write`
