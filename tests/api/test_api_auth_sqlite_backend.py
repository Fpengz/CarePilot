...
def test_sqlite_auth_password_change_persists_and_emits_audit_events(
    sqlite_auth_env: None,
) -> None:
    app = create_app()
    client_a = TestClient(app)
    ...
    patch = client_a.patch(
        ...
        json={
            ...
            "new_password": "member-pass-sqlite",
        },
    )
    assert patch.status_code == 200
...
def test_sqlite_auth_audit_events_enforce_admin_scope(
    sqlite_auth_env: None,
) -> None:
